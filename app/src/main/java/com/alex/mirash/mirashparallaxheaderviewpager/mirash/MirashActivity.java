...
import com.alex.mirash.mirashparallaxheaderviewpager.astuetz.PagerSlidingTabStrip;
import com.alex.mirash.mirashparallaxheaderviewpager.newsstand.SampleListFragment;
import com.alex.mirash.mirashparallaxheaderviewpager.newsstand.ScrollTabHolder;
import com.alex.mirash.mirashparallaxheaderviewpager.newsstand.ScrollTabHolderFragment;
import com.alex.mirash.mirashparallaxheaderviewpager.notboringactionbar.AlphaForegroundColorSpan;
import com.alex.mirash.mirashparallaxheaderviewpager.notboringactionbar.KenBurnsSupportView;
import com.nineoldandroids.view.ViewHelper;

public class MirashActivity extends ActionBarActivity implements ScrollTabHolder, ViewPager.OnPageChangeListener {
...
//            interpolate(mHeaderLogo, getActionBarIconView(), sSmoothInterpolator.getInterpolation(ratio));
    ...
    private ImageView getActionBarIconView() {
        logView(android.R.id.home);
        logView(android.support.v7.appcompat.R.id.home);
        int id_home = getResources().getIdentifier("home", "id", "android.support.v7.appcompat");
        logView(id_home);
        id_home = getResources().getIdentifier("home", "id", "android");
        logView(id_home);
    ...
    private void logView(int id) {
        View view = findViewById(id);
        Log.d("LOL", (view == null ? "null" : "GOOD!"));
    }
